  ...
  return (
    <>
      <div className="flex justify-center bg-black ">
        <div className="flex flex-col  bg-slate-50 max-w-[920px]  p-4">
          <div>
            <CloseButton
              size="lg"
              background={"green"}
          ...
          <div className="pt-4">
            <h1 className="text-5xl font-Poppins">{blog.title}</h1>
          </div>
          <div className="userinfo pt-5 flex gap-3 items-center justify-start">
            ...
            <div className="user-text flex flex-col">
              <div className="flex gap-2">
                <h1>{user.username}</h1>
                <p>●</p>
                <button className="text-green-600 font-semibold">Follow</button>
              </div>
              <div>
          ...
          <div className=" pt-8">
            ...
            <div className="logos pt-6 pb-6 flex justify-between">
              <div className="left-logo flex gap-3">
              ...
              <div className="right-logo">
                <div className="like flex gap-3 justify-center items-center">
                  <button>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      height="24px"
          ...
          <div className="image pt-1 h-full w-full">
            <img
              src={blog.images}
              alt=""
          ...
          <div className="content-text pt-10 text-lg">{blog.content}</div>
        </div>
      </div>
